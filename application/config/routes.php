...
$route['admin/sports-categories'] = 'admin/sports_categories';
$route['admin/add-category'] = 'admin/add_category';
$route['admin/add-venue'] = 'admin/add_venue';
$route['admin/add-ground'] = 'admin/add_ground';
