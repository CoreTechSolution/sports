<div class="row">
	<div class="col-md-12">
		<div class="white-box">
			<div style="text-align: right"><a href="<?php echo base_url('admin/add-category') ?>" class="btn btn-primary btn-primary-link">Add Sports</a></div>
			<br>
			<table class="table">
				<thead>
					<tr>
				...
				<?php if(!empty($sports_categories)){ ?>
					...
					<tr>
						...
						<td style="text-align: right;"><a href="<?php echo base_url('admin/delete_category'); ?>/?category_id=<?php echo $sports_category['category_id']; ?>">Delete</a></td>
					</tr>
					<?php } ?>
				<?php } ?>
				</tbody>
